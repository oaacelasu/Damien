...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        showToolbar(getResources().getString(R.string.home_fragment_tittle), false, view);

        RecyclerView picturesRecycler = (RecyclerView) view.findViewById(R.id.picureRecycler);
